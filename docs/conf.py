...
version = pygazebo.__version__
# The full version, including alpha/beta/rc tags.
release = pygazebo.__version__
...
latex_documents = [
  ('index', 'pygazebo.tex', u'pygazebo Documentation',
   u'Josh Pieper', 'manual'),
]
